      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Image
              src="https://ik.imagekit.io/j98e6hcfnkn/featured/deck-staining/5_DkRgyuNVi.jpg?updatedAt=1681571800892&tr=n-ik_ml_thumbnail"
            ...
            />
                ...
                <div className="relative aspect-square">
            <Image
              src="https://ik.imagekit.io/j98e6hcfnkn/featured/deck-staining/4_WI2HGCsBC.jpg?updatedAt=1681571779303&tr=n-ik_ml_thumbnail"
            ...
            />
                ...
                <div className="relative aspect-square">
            <Image
              src="https://ik.imagekit.io/j98e6hcfnkn/featured/deck-staining/deckstain-solid.jpg?updatedAt=1747995087459&tr=n-ik_ml_thumbnail"
            ...
            <p className="text-gray-600 mb-4">
              This commercial office space was renovated with a contemporary color palette for a productive and inviting work environment.
            </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-brand-blue/10 text-brand-blue text-sm px-3 py-1 rounded-full">
                    Interior Painting
