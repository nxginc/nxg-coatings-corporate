                        ...
                        {link.children ? (
                          <div>
                            <button
                              ...
                              className="w-full flex items-center justify-between text-lg font-medium text-gray-800 hover:text-brand-red"
                            >
                              {link.label}
                              <motion.div
                            ...
                            <AnimatePresence>
                              {expandedMenus.includes(link.label) && (
                                ...
                                >
                                  <div className="mt-2 ml-4 space-y-2 border-l-2 border-brand-red/20 pl-4">
                                    {link.children.map((child) => (
                                      <motion.div
                                        key={child.label}
                          ...
                          <Link
                            href={link.href}
                            className="block text-lg font-medium text-gray-800 hover:text-brand-red"
                          >
                            {link.label}
                          </Link>
                        )}
